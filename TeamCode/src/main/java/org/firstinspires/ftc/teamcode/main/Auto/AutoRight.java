...
public class AutoRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder grab1 = robot.roadRunner.actionBuilder(new Pose2d(52, -2, Math.toRadians(180)))
                ...
                .splineToLinearHeading(new Pose2d(19.6, -43.5, Math.toRadians(320)), Math.toRadians(320))
        ...
        TrajectoryActionBuilder drop1 = robot.roadRunner.actionBuilder(new Pose2d(19.6, -43.5, Math.toRadians(320)))
        ...
        TrajectoryActionBuilder grab2 = robot.roadRunner.actionBuilder(new Pose2d(19.5, -50, Math.toRadians(225)))
                .splineToLinearHeading(new Pose2d(19.6, -61, Math.toRadians(320)), Math.toRadians(320))
                .stopAndAdd(new InstantAction(() -> Robot.rb.intake.arm.down()))
                .waitSeconds(0.25)
                .stopAndAdd(new InstantAction(() -> Robot.rb.intake.hand.close()))
                .waitSeconds(0.15)
        ...
        TrajectoryActionBuilder drop2 = robot.roadRunner.actionBuilder(new Pose2d(19.6, -61, Math.toRadians(320)))
